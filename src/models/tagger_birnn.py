...
class TaggerBiRNN(TaggerBase):
    ...
    def __init__(self, word_seq_indexer, tag_seq_indexer, class_num, batch_size=1, rnn_hidden_dim=100,
        ...
        if (word_seq_indexer.xlnet):
            self.word_embeddings_layer = LayerContextWordEmbeddingsXlNet(word_seq_indexer, gpu, freeze_word_embeddings, embedding_dim=embedding_dim)
