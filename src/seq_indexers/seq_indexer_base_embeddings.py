...
class SeqIndexerBaseEmbeddings(SeqIndexerBase):
    ...
    """
    def __init__(self, gpu, check_for_lowercase, zero_digits, pad, unk, load_embeddings, embeddings_dim, verbose, isElmo = False, isBert = False, isXlnet = False):
        SeqIndexerBase.__init__(self, gpu, check_for_lowercase, zero_digits, pad, unk, load_embeddings, embeddings_dim,
                                verbose, isElmo, isBert, isXlnet=isXlnet)
    @staticmethod
