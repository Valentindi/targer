...
class SeqIndexerBert(SeqIndexerBaseEmbeddings):
    ...
    def __init__(self, gpu=-1, check_for_lowercase=True, embeddings_dim=0, verbose=True,
                 ...
                 bert_type='bert-base-uncased', model_frozen=True):
        ...
        for elem in [self.emb.embeddings.word_embeddings, self.emb.embeddings.position_embeddings,
                     self.emb.embeddings.token_type_embeddings, self.emb.embeddings.LayerNorm]:
