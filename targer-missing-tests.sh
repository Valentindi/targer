...
name="run-hidden-666"
python main.py --train $train --dev $dev --test $test --save $name.hdf5 --rnn-hidden-dim 666  --save-best yes --cross-folds-num 5 -v $eval -p 25 -e $e -g -1 
python run_tagger.py $name.hdf5 $test -g -1 -o $name.json
python eval.py $test $name.json $name.eval.txt
python generate_detailed_report.py $test $name.json $name.report.html
...
name="lr-0.001"
python main.py --train $train --dev $dev --test $test --save $name.hdf5 --lr 0.001  --save-best yes --cross-folds-num 5 -v $eval -p 25 -e $e -g -1 
python run_tagger.py $name.hdf5 $test -g -1 -o $name.json
python eval.py $test $name.json $name.eval.txt
python generate_detailed_report.py $test $name.json $name.report.html
...
name="lr-0.005"
python main.py --train $train --dev $dev --test $test --save $name.hdf5 --lr 0.005  --save-best yes --cross-folds-num 5 -v $eval -p 25 -e $e -g -1 
python run_tagger.py $name.hdf5 $test -g -1 -o $name.json
python eval.py $test $name.json $name.eval.txt
python generate_detailed_report.py $test $name.json $name.report.html
...
name="lr-0.05"
python main.py --train $train --dev $dev --test $test --save $name.hdf5 --lr 0.05  --save-best yes --cross-folds-num 5 -v $eval -p 25 -e $e -g -1 
python run_tagger.py $name.hdf5 $test -g -1 -o $name.json
python eval.py $test $name.json $name.eval.txt
python generate_detailed_report.py $test $name.json $name.report.html
...
python main.py --train $train --dev $dev --test $test --save $name.hdf5  --model BiRNNCRF --rnn-type=GRU --rnn-hidden-dim 500   --save-best yes --cross-folds-num 5 -v $eval -p 25 -e $e -g -1 
python run_tagger.py $name.hdf5 $test -g -1 -o $name.json
python eval.py $test $name.json $name.eval.txt
python generate_detailed_report.py $test $name.json $name.report.html
